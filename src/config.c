...
free_config()
{
	if (zircon_config.nickname) { free(zircon_config.nickname); }

	if (zircon_config.username) { free(zircon_config.username); }

	if (zircon_config.fullname) { free(zircon_config.fullname); }
}
